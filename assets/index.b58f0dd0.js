...
var oC = Ge
  , iC = {
    ...
    about: {
        introduction: "欢迎使用丰帆象棋,本网页采用了最先进的神经网络NNUE算法,现已经超过人类棋手!",
        thanksForSupport: "",
        thanksPikacat: "",
        thanksDblue: "",
        thanksPikafishTeams: "",
    ...
    about: {
        introduction: "Welcome to Fengfan Chess! This webpage employs the most advanced NNUE neural network algorithm, which has now surpassed human players!",
        thanksForSupport: "",
        thanksPikacat: "",
        thanksDblue: "",
        thanksPikafishTeams: "",
