import {j as S} from "./index.b58f0dd0.js";
function L(b, g) {
    return g.forEach(function(r) {
        r && typeof r != "string" && !Array.isArray(r) && Object.keys(r).forEach(function(u) {
            if (u !== "default" && !(u in b)) {
                var i = Object.getOwnPropertyDescriptor(r, u);
                Object.defineProperty(b, u, i.get ? i : {
                    enumerable: !0,
                    get: function() {
                        return r[u]
                    }
    ...
    Object.freeze(Object.defineProperty(b, Symbol.toStringTag, {
        value: "Module"
    }))
}
var O = {};
    ...
    (function() {
        ...
        g.prototype = {
            ...
            unload: function() {
                for (var e = this || r, t = e._howls.length - 1; t >= 0; t--)
                    e._howls[t].unload();
                return e.usingWebAudio && e.ctx && typeof e.ctx.close != "undefined" && (e.ctx.close(),
                e.ctx = null,
                A()),
                e
            },
                    ...
                    var t = function(n) {
                        ...
                        for (var _ = 0; _ < e._howls.length; _++)
                            if (!e._howls[_]._webAudio)
                                for (var l = e._howls[_]._getSoundIds(), a = 0; a < l.length; a++) {
        ...
        u.prototype = {
            init: function(e) {
                ...
                t._loop = e.loop || !1,
                t._pool = e.pool || 5,
                t._preload = typeof e.preload == "boolean" || e.preload === "metadata" ? e.preload : !0,
                t._rate = e.rate || 1,
                t._sprite = e.sprite || {},
                ...
                typeof r.ctx != "undefined" && r.ctx && r.autoUnlock && r._unlockAudio(),
                r._howls.push(t),
            ...
            load: function() {
                ...
                return e._src = t,
                e._state = "loading",
                window.location.protocol === "https:" && t.slice(0, 5) === "http:" && (e._html5 = !0,
                e._webAudio = !1),
                new i(e),
                e._webAudio && d(e),
                e
            ...
            play: function(e, t) {
                ...
                if (typeof e == "number")
                    ...
                    if (typeof e == "string" && n._state === "loaded" && !n._sprite[e])
                        return null;
                    if (typeof e == "undefined" && (e = "__default",
                    !n._playLock)) {
                        for (var _ = 0, l = 0; l < n._sounds.length; l++)
                            n._sounds[l]._paused && !n._sounds[l]._ended && (_++,
                            o = n._sounds[l]._id);
                        _ === 1 ? e = null : o = null
                    }
                }
                ...
                var m = Math.max(0, a._seek > 0 ? a._seek : n._sprite[e][0] / 1e3)
                  ...
                  , T = n._sprite[e][0] / 1e3
                  , I = (n._sprite[e][0] + n._sprite[e][1]) / 1e3;
                a._sprite = e,
                a._ended = !1;
                var k = function() {
                    a._paused = !1,
                ...
                if (n._webAudio) {
                    var H = function() {
                        ...
                        typeof v.bufferSource.start == "undefined" ? a._loop ? v.bufferSource.noteGrainOn(0, m, 86400) : v.bufferSource.noteGrainOn(0, m, y) : a._loop ? v.bufferSource.start(0, m, 86400) : v.bufferSource.start(0, m, y),
                    ...
                    r.state === "running" && r.ctx.state !== "interrupted" ? H() : (n._playLock = !0,
                    n.once("resume", H),
                    n._clearTimer(a._id))
                } else {
                    var P = function() {
                        ...
                        try {
                            var x = v.play();
                            if (x && typeof Promise != "undefined" && (x instanceof Promise || typeof x.then == "function") ? (n._playLock = !0,
                            k(),
                            x.then(function() {
                                n._playLock = !1,
                                v._unlocked = !0,
                    ...
                    v.src === "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA" && (v.src = n._src,
                    v.load());
                    var F = window && window.ejecta || !v.readyState && r._navigator.isCocoonJS;
                    if (v.readyState >= 3 || F)
                        P();
                    else {
                        n._playLock = !0,
                        ...
                        v.addEventListener(r._canPlayEvent, M, !1),
                        n._clearTimer(a._id)
                    }
                }
                return a._id
            ...
            pause: function(e) {
                ...
                for (var n = t._getSoundIds(e), o = 0; o < n.length; o++) {
                    ...
                    if (_ && !_._paused && (_._seek = t.seek(n[o]),
                    _._rateSeek = 0,
                    _._paused = !0,
                    t._stopFade(n[o]),
                    _._node))
            ...
            stop: function(e, t) {
                ...
                for (var o = n._getSoundIds(e), _ = 0; _ < o.length; _++) {
                    ...
                    l._ended = !0,
                    n._stopFade(o[_]),
                    l._node && (n._webAudio ? l._node.bufferSource && (typeof l._node.bufferSource.stop == "undefined" ? l._node.bufferSource.noteOff(0) : l._node.bufferSource.stop(0),
                    n._cleanBuffer(l._node)) : (!isNaN(l._node.duration) || l._node.duration === 1 / 0) && (l._node.currentTime = l._start || 0,
                    l._node.pause(),
            ...
            mute: function(e, t) {
                ...
                for (var o = n._getSoundIds(t), _ = 0; _ < o.length; _++) {
                    ...
                    n._webAudio && l._node ? l._node.gain.setValueAtTime(e ? 0 : l._volume, r.ctx.currentTime) : l._node && (l._node.muted = r._muted ? !0 : e),
                    n._emit("mute", l._id))
                }
                return n
            },
            volume: function() {
                ...
                if (typeof n != "undefined" && n >= 0 && n <= 1) {
                    if (e._state !== "loaded" || e._playLock)
                        ...
                        e;
                    typeof o == "undefined" && (e._volume = n),
                    o = e._getSoundIds(o);
                    for (var f = 0; f < o.length; f++)
                        a = e._soundById(o[f]),
                        a && (a._volume = n,
                        t[2] || e._stopFade(o[f]),
                        e._webAudio && a._node && !a._muted ? a._node.gain.setValueAtTime(n, r.ctx.currentTime) : a._node && !a._muted && (a._node.volume = n * r.volume()),
                        e._emit("volume", a._id))
                } else
                    return a = o ? e._soundById(o) : e._sounds[0],
                    a ? a._volume : 0;
                return e
            },
            fade: function(e, t, n, o) {
                ...
                for (var l = _._getSoundIds(o), a = 0; a < l.length; a++) {
                    ...
                    if (f) {
                        if (o || _._stopFade(l[a]),
                        _._webAudio && !f._muted) {
                        ...
                        _._startFadeInterval(f, e, t, n, l[a], typeof o == "undefined")
                    }
                }
                return _
            },
            _startFadeInterval: function(e, t, n, o, _, l) {
                ...
                e._interval = setInterval(function() {
                    ...
                    l && (a._volume = f),
                    (n < t && f <= n || n > t && f >= n) && (clearInterval(e._interval),
                    e._interval = null,
                    e._fadeTo = null,
                    a.volume(n, e._id),
                    a._emit("fade", e._id))
            ...
            loop: function() {
                ...
                if (t.length === 1)
                    if (typeof t[0] == "boolean")
                        ...
                        return _ = e._soundById(parseInt(t[0], 10)),
                        _ ? _._loop : !1;
                else
                    t.length === 2 && (n = t[0],
                    o = parseInt(t[1], 10));
                for (var l = e._getSoundIds(o), a = 0; a < l.length; a++)
                    _ = e._soundById(l[a]),
                    _ && (_._loop = n,
                    e._webAudio && _._node && _._node.bufferSource && (_._node.bufferSource.loop = n,
                    n && (_._node.bufferSource.loopStart = _._start || 0,
                    _._node.bufferSource.loopEnd = _._stop,
                    e.playing(l[a]) && (e.pause(l[a], !0),
                    e.play(l[a], !0)))));
                return e
            },
            rate: function() {
                ...
                if (typeof n == "number") {
                    if (e._state !== "loaded" || e._playLock)
                        ...
                        e;
                    typeof o == "undefined" && (e._rate = n),
                    o = e._getSoundIds(o);
                    for (var f = 0; f < o.length; f++)
                        if (a = e._soundById(o[f]),
                        a) {
                            e.playing(o[f]) && (a._rateSeek = e.seek(o[f]),
                            a._playStart = e._webAudio ? r.ctx.currentTime : a._playStart),
                            a._rate = n,
                            e._webAudio && a._node && a._node.bufferSource ? a._node.bufferSource.playbackRate.setValueAtTime(n, r.ctx.currentTime) : a._node && (a._node.playbackRate = n);
                            var m = e.seek(o[f])
                              , y = (e._sprite[a._sprite][0] + e._sprite[a._sprite][1]) / 1e3 - m
                              , w = y * 1e3 / Math.abs(a._rate);
                            (e._endTimers[o[f]] || !a._paused) && (e._clearTimer(o[f]),
                            e._endTimers[o[f]] = setTimeout(e._ended.bind(e, a), w)),
                            e._emit("rate", a._id)
                        }
                } else
                    return a = e._soundById(o),
                    a ? a._rate : e._rate;
                return e
            },
            seek: function() {
                ...
                if (t.length === 0)
                    ...
                    var _ = e._getSoundIds()
                      , l = _.indexOf(t[0]);
                    l >= 0 ? o = parseInt(t[0], 10) : e._sounds.length && (o = e._sounds[0]._id,
                    n = parseFloat(t[0]))
                } else
                    t.length === 2 && (n = parseFloat(t[0]),
                    o = parseInt(t[1], 10));
            ...
            on: function(e, t, n, o) {
                var _ = this
                  , l = _["_on" + e];
                return typeof t == "function" && l.push(o ? {
                    id: n,
                    fn: t,
                    once: o
                } : {
            ...
            off: function(e, t, n) {
                ...
                t || n)
                    ...
                    for (l = 0; l < f.length; l++)
                        f[l].indexOf("_on") === 0 && Array.isArray(o[f[l]]) && (o[f[l]] = [])
                }
                return o
            },
            once: function(e, t, n) {
            ...
            _emit: function(e, t, n) {
                for (var o = this, _ = o["_on" + e], l = _.length - 1; l >= 0; l--)
                    (!_[l].id || _[l].id === t || e === "load") && (setTimeout(function(a) {
                        a.call(this, t, n)
                    }
                    .bind(o, _[l].fn), 0),
            ...
            _ended: function(e) {
                ...
                return t._webAudio && !o && (e._paused = !0,
                e._ended = !0,
                e._seek = e._start || 0,
                e._rateSeek = 0,
                t._clearTimer(e._id),
        ...
        i.prototype = {
            ...
            create: function() {
                ...
                return t._webAudio ? (e._node = typeof r.ctx.createGain == "undefined" ? r.ctx.createGainNode() : r.ctx.createGain(),
            ...
            _loadListener: function() {
                ...
                Object.keys(t._sprite).length === 0 && (t._sprite = {
                    __default: [0, t._duration * 1e3]
                }),
                t._state !== "loaded" && (t._state = "loaded",
                t._emit("load"),
                t._loadQueue()),
            ...
            _endListener: function() {
                var e = this
                  , t = e._parent;
                t._duration === 1 / 0 && (t._duration = Math.ceil(e._node.duration * 10) / 10,
        ...
        var c = {}
          , d = function(e) {
            ...
            if (/^data:[^;]+;base64,/.test(t)) {
                for (var n = atob(t.split(",")[1]), o = new Uint8Array(n.length), _ = 0; _ < n.length; ++_)
                    o[_] = n.charCodeAt(_);
                p(o.buffer, e)
            } else {
                ...
                e._xhr.headers && Object.keys(e._xhr.headers).forEach(function(a) {
          ...
          , p = function(e, t) {
            var n = function() {
              ...
              , o = function(_) {
                _ && t._sounds.length > 0 ? (c[t._src] = _,
                s(t, _)) : n()
            };
          ...
          , A = function() {
            if (!!r.usingWebAudio) {
                ...
                r.usingWebAudio && (r.masterGain = typeof r.ctx.createGain == "undefined" ? r.ctx.createGainNode() : r.ctx.createGain(),
        ...
        b.Howler = r,
        b.Howl = u,
        typeof S != "undefined" ? (S.HowlerGlobal = g,
        S.Howler = r,
        S.Howl = u,
        S.Sound = i) : typeof window != "undefined" && (window.HowlerGlobal = g,
        window.Howler = r,
        window.Howl = u,
        window.Sound = i)
    }
    ...
    (function() {
        ...
        HowlerGlobal.prototype.stereo = function(r) {
            ...
            if (!u.ctx || !u.ctx.listener)
                return u;
            for (var i = u._howls.length - 1; i >= 0; i--)
                u._howls[i].stereo(r);
            return u
        }
        ,
        HowlerGlobal.prototype.pos = function(r, u, i) {
            ...
            if (!c.ctx || !c.ctx.listener)
                return c;
            if (u = typeof u != "number" ? c._pos[1] : u,
            i = typeof i != "number" ? c._pos[2] : i,
            typeof r == "number")
                c._pos = [r, u, i],
                typeof c.ctx.listener.positionX != "undefined" ? (c.ctx.listener.positionX.setTargetAtTime(c._pos[0], Howler.ctx.currentTime, .1),
                c.ctx.listener.positionY.setTargetAtTime(c._pos[1], Howler.ctx.currentTime, .1),
                c.ctx.listener.positionZ.setTargetAtTime(c._pos[2], Howler.ctx.currentTime, .1)) : c.ctx.listener.setPosition(c._pos[0], c._pos[1], c._pos[2]);
            else
                return c._pos;
            return c
        }
        ...
        HowlerGlobal.prototype.orientation = function(r, u, i, c, d, h) {
            ...
            if (u = typeof u != "number" ? s[1] : u,
            i = typeof i != "number" ? s[2] : i,
            c = typeof c != "number" ? s[3] : c,
            d = typeof d != "number" ? s[4] : d,
            h = typeof h != "number" ? s[5] : h,
            typeof r == "number")
                p._orientation = [r, u, i, c, d, h],
                typeof p.ctx.listener.forwardX != "undefined" ? (p.ctx.listener.forwardX.setTargetAtTime(r, Howler.ctx.currentTime, .1),
                p.ctx.listener.forwardY.setTargetAtTime(u, Howler.ctx.currentTime, .1),
                p.ctx.listener.forwardZ.setTargetAtTime(i, Howler.ctx.currentTime, .1),
                p.ctx.listener.upX.setTargetAtTime(c, Howler.ctx.currentTime, .1),
                p.ctx.listener.upY.setTargetAtTime(d, Howler.ctx.currentTime, .1),
                p.ctx.listener.upZ.setTargetAtTime(h, Howler.ctx.currentTime, .1)) : p.ctx.listener.setOrientation(r, u, i, c, d, h);
            else
                return s;
            return p
        }
        ...
        Howl.prototype.init = function(r) {
            return function(u) {
                var i = this;
                return i._orientation = u.orientation || [1, 0, 0],
                i._stereo = u.stereo || null,
                i._pos = u.pos || null,
                i._pannerAttr = {
                    coneInnerAngle: typeof u.coneInnerAngle != "undefined" ? u.coneInnerAngle : 360,
                    coneOuterAngle: typeof u.coneOuterAngle != "undefined" ? u.coneOuterAngle : 360,
                    coneOuterGain: typeof u.coneOuterGain != "undefined" ? u.coneOuterGain : 0,
                    distanceModel: typeof u.distanceModel != "undefined" ? u.distanceModel : "inverse",
                    maxDistance: typeof u.maxDistance != "undefined" ? u.maxDistance : 1e4,
                    panningModel: typeof u.panningModel != "undefined" ? u.panningModel : "HRTF",
                    refDistance: typeof u.refDistance != "undefined" ? u.refDistance : 1,
                    rolloffFactor: typeof u.rolloffFactor != "undefined" ? u.rolloffFactor : 1
                },
        ...
        Howl.prototype.stereo = function(r, u) {
            ...
            if (i._state !== "loaded")
                ...
                i;
            var c = typeof Howler.ctx.createStereoPanner == "undefined" ? "spatial" : "stereo";
            ...
            for (var d = i._getSoundIds(u), h = 0; h < d.length; h++) {
                ...
                if (p)
                    if (typeof r == "number")
                        ...
                        c === "spatial" ? typeof p._panner.positionX != "undefined" ? (p._panner.positionX.setValueAtTime(r, Howler.ctx.currentTime),
                        p._panner.positionY.setValueAtTime(0, Howler.ctx.currentTime),
                        p._panner.positionZ.setValueAtTime(0, Howler.ctx.currentTime)) : p._panner.setPosition(r, 0, 0) : p._panner.pan.setValueAtTime(r, Howler.ctx.currentTime)),
        ...
        Howl.prototype.pos = function(r, u, i, c) {
            ...
            for (var h = d._getSoundIds(c), p = 0; p < h.length; p++) {
                ...
                if (s)
                    if (typeof r == "number")
                        s._pos = [r, u, i],
                        s._node && ((!s._panner || s._panner.pan) && g(s, "spatial"),
                        typeof s._panner.positionX != "undefined" ? (s._panner.positionX.setValueAtTime(r, Howler.ctx.currentTime),
                        s._panner.positionY.setValueAtTime(u, Howler.ctx.currentTime),
                        s._panner.positionZ.setValueAtTime(i, Howler.ctx.currentTime)) : s._panner.setPosition(r, u, i)),
                        d._emit("pos", s._id);
                    else
                        return s._pos
            }
        ...
        Howl.prototype.orientation = function(r, u, i, c) {
            ...
            if (d._state !== "loaded")
                ...
                d;
            if (u = typeof u != "number" ? d._orientation[1] : u,
            i = typeof i != "number" ? d._orientation[2] : i,
            typeof c == "undefined")
                if (typeof r == "number")
                    d._orientation = [r, u, i];
                else
            ...
            for (var h = d._getSoundIds(c), p = 0; p < h.length; p++) {
                ...
                if (s)
                    if (typeof r == "number")
                        ...
                        s._node && (s._panner || (s._pos || (s._pos = d._pos || [0, 0, -.5]),
                        g(s, "spatial")),
                        typeof s._panner.orientationX != "undefined" ? (s._panner.orientationX.setValueAtTime(r, Howler.ctx.currentTime),
                        s._panner.orientationY.setValueAtTime(u, Howler.ctx.currentTime),
                        s._panner.orientationZ.setValueAtTime(i, Howler.ctx.currentTime)) : s._panner.setOrientation(r, u, i)),
                        d._emit("orientation", s._id);
                    else
        ...
        Howl.prototype.pannerAttr = function() {
            ...
            if (u.length === 1)
                if (typeof u[0] == "object")
                    i = u[0],
                    typeof c == "undefined" && (i.pannerAttr || (i.pannerAttr = {
                    ...
                    return d = r._soundById(parseInt(u[0], 10)),
                    d ? d._pannerAttr : r._pannerAttr;
            else
                u.length === 2 && (i = u[0],
                c = parseInt(u[1], 10));
            for (var h = r._getSoundIds(c), p = 0; p < h.length; p++)
                if (d = r._soundById(h[p]),
                d) {
                    var s = d._pannerAttr;
                    s = {
                        coneInnerAngle: typeof i.coneInnerAngle != "undefined" ? i.coneInnerAngle : s.coneInnerAngle,
                        coneOuterAngle: typeof i.coneOuterAngle != "undefined" ? i.coneOuterAngle : s.coneOuterAngle,
                        coneOuterGain: typeof i.coneOuterGain != "undefined" ? i.coneOuterGain : s.coneOuterGain,
                        distanceModel: typeof i.distanceModel != "undefined" ? i.distanceModel : s.distanceModel,
                        maxDistance: typeof i.maxDistance != "undefined" ? i.maxDistance : s.maxDistance,
                        refDistance: typeof i.refDistance != "undefined" ? i.refDistance : s.refDistance,
                        rolloffFactor: typeof i.rolloffFactor != "undefined" ? i.rolloffFactor : s.rolloffFactor,
                        panningModel: typeof i.panningModel != "undefined" ? i.panningModel : s.panningModel
                    };
                    var A = d._panner;
                    A || (d._pos || (d._pos = r._pos || [0, 0, -.5]),
                    g(d, "spatial"),
                    A = d._panner),
        ...
        Sound.prototype.init = function(r) {
            return function() {
                ...
                r.call(this),
                u._stereo ? i.stereo(u._stereo) : u._pos && i.pos(u._pos[0], u._pos[1], u._pos[2], u._id)
            }
        ...
        Sound.prototype.reset = function(r) {
            return function() {
                var u = this
                  , i = u._parent;
                return u._orientation = i._orientation,
                u._stereo = i._stereo,
                u._pos = i._pos,
                u._pannerAttr = i._pannerAttr,
                u._stereo ? i.stereo(u._stereo) : u._pos ? i.pos(u._pos[0], u._pos[1], u._pos[2], u._id) : u._panner && (u._panner.disconnect(0),
                u._panner = void 0,
                i._refreshBuffer(u)),
                r.call(this)
            }
        ...
        var g = function(r, u) {
            u = u || "spatial",
            u === "spatial" ? (r._panner = Howler.ctx.createPanner(),
            ...
            typeof r._panner.positionX != "undefined" ? (r._panner.positionX.setValueAtTime(r._pos[0], Howler.ctx.currentTime),
            ...
            typeof r._panner.orientationX != "undefined" ? (r._panner.orientationX.setValueAtTime(r._orientation[0], Howler.ctx.currentTime),
