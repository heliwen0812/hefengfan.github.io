...
if (!Da(F)) {
  var Ea = F;
  F = 'https://hefengfan.github.io/engine/main_20240816v7/single_simd/pikafish.wasm';
}
function Fa(a) {
  if (a == F && oa) {
...
function Ha(a, b, c) {
  return Ga('https://hefengfan.github.io/engine/main_20240816v7/single_simd/pikafish.wasm').then(d => WebAssembly.instantiate(d, b)).then(c, d => {
