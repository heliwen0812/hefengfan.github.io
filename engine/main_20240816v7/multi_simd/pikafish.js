...
if (!ab(bb)) {
  var cb = bb;
  bb = "https://xiangqiai.com/engine/main_20240816v7/multi_simd/pikafish.wasm";
}
function db(a) {
  if (a == bb && Ka) {
...
function fb(a, b, c) {
  return eb('https://xiangqiai.com/engine/main_20240816v7/multi_simd/pikafish.wasm').then(d => WebAssembly.instantiate(d, b)).then(c, d => {
